  ...
  ({ className, title, description, items, contactInfo, ...props }, ref) => {
    return (
      <section
        ref={ref}
        className={cn(
          'py-16 w-full font-ubuntu bg-transparent from-transparent via-muted/50 to-transparent',
          className
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      >
        <h3
          className={cn(
            'lg:text-base sm:text-sm text-xs font-medium transition-colors duration-200 text-left',
